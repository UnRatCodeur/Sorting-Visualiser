 ...
 * @author Juju_2
 */
public class InsersionSortPanel extends SortPanel implements Runnable{
    ...
    public InsersionSortPanel(int sleeptime, int[] arrayToSort, int numberOfRows) {
        super(sleeptime, arrayToSort, "Insersion Sort", "O(n/n²/n²)", "O(1)", numberOfRows);
    }
    ...
    public void run() {
        ...
        try {
            ...
            for(int i=1;i<size;i++){
                ...
                if(j!=0){arrayComparisons++; repaint();Thread.sleep(sleeptime);}
            }
