 ...
 * @author Juju_2
 */
public class BubbleSortPanel extends SortPanel implements Runnable{
    ...
    public BubbleSortPanel(int sleeptime, int[] arrayToSort, int numberOfRows) {
        super(sleeptime, arrayToSort, "Bubble Sort", "O(n²)", "O(1)", numberOfRows);
    }
