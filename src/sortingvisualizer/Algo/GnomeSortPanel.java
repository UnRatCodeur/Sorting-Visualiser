 ...
 * @author Juju_2
 */
public class GnomeSortPanel extends SortPanel implements Runnable{
     private int indexGreen=-1;
    private int indexRed=-1;
    private int indexBlue=-1;
    
    
    public GnomeSortPanel(int sleeptime, int[] arrayToSort, int numberOfRows) {
        super(sleeptime, arrayToSort, "Gnome Sort", "O(n/n²/n²)", "O(1)", numberOfRows);
    }
